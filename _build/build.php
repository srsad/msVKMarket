...
class msVKMarketPackage
{
    ...
    {
        /** @noinspection PhpIncludeInspection */
        $snippets = include($this->config['elements'] . '_snippets.php');
...
$install = new msVKMarketPackage(MODX_CORE_PATH, $config);

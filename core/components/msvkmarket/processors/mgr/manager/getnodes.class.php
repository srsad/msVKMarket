...
class msVKMarketManagerGetNodesProcessor extends modResourceGetNodesProcessor
{
    ...
    public function getResourceQuery()
    {
        ...
        $c->leftJoin('modResource', 'Child', array(
            'modResource.id = Child.parent'
        ));
        $c->leftJoin('msCategoryMember', 'Member', 'modResource.id = Member.category_id AND Member.product_id = ' . $this->resource_id);
...
return 'msVKMarketManagerGetNodesProcessor';